          ...
          if (context == "good") {
            if (tipoBusqueda == "exactly") {
              ...
              for (var i = 0; i < decodedData["result"][0].length; i++) {
                ...
                productoModel.productoCharacteristics = decodedData["result"][0]
                ...
                productoModel.productoStockStatus =
                    decodedData['subsidiary_good_stock_status'];
                productoModel.productoMeasure = decodedData["result"][0][i]
                ...
                companyModel.companyRuc =
                    decodedData["result"][0][i]['company_ruc'];
                companyModel.companyImage =
                ...
                companyModel.companyMt =
                    decodedData["result"][0][i]['company_mt'];
                companyModel.idCity = decodedData["result"][0][i]['id_country'];
                companyModel.cityName =
                    decodedData["result"][0][i]['city_name'];
                companyModel.distancia =
                    decodedData["result"][0][i]['distancia'];
                ...
                categ.categoryName =
                    decodedData["result"][0][i]["category_name"];
