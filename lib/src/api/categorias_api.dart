...
class CategoriasApi {
  ...
  Future<int> obtenerCategorias(BuildContext context) async {
    ...
    try {
      var response = await http.post(Uri.parse("$apiBaseURL/api/Inicio/listar_categorias"), body: {});
      ...
      for (var i = 0; i < res.length; i++) {
        ...
        if (preferences.cargaCategorias == null || preferences.cargaCategorias == '0') {
  ...
  Future<int> obtenerbsResumen() async {
    try {
      var response = await http.post(Uri.parse("$apiBaseURL/api/Inicio/listar_bs_por_id_ciudad_resume"), body: {'id_ciudad': '1'});
      ...
      for (int i = 0; i < decodedData['bienes'].length; i++) {
        ...
        var categoryList = await categoryDatabase.obtenerCategoriasporID(bienesList['id_category']);
        ...
        ItemSubCategoriaModel itemSubCategoriaModel = ItemSubCategoriaModel();
        itemSubCategoriaModel.idItemsubcategory = bienesList['id_itemsubcategory'];
        ...
        await itemsubCategoryDatabase.insertarItemSubCategoria(itemSubCategoriaModel, 'Inicio/listar_bs_por_id_ciudad_resume');
        ...
        subsidiaryModel.subsidiaryCellphone = bienesList['subsidiary_cellphone'];
        subsidiaryModel.subsidiaryCellphone2 = bienesList['subsidiary_cellphone_2'];
        ...
        subsidiaryModel.subsidiaryOpeningHours = bienesList['subsidiary_opening_hours'];
        subsidiaryModel.subsidiaryPrincipal = bienesList['subsidiary_principal'];
        ...
        subsidiaryGoodModel.idItemsubcategory = bienesList['id_itemsubcategory'];
        ...
        subsidiaryGoodModel.productoCurrency = bienesList['subsidiary_good_currency'];
        subsidiaryGoodModel.productoImage = bienesList['subsidiary_good_image'];
        subsidiaryGoodModel.productoCharacteristics = bienesList['subsidiary_good_characteristics'];
        ...
        subsidiaryGoodModel.productoMeasure = bienesList['subsidiary_good_stock_measure'];
        subsidiaryGoodModel.productoRating = bienesList['subsidiary_good_rating'];
        subsidiaryGoodModel.productoUpdated = bienesList['subsidiary_good_updated'];
        subsidiaryGoodModel.productoStatus = bienesList['subsidiary_good_status'];

        var productList = await productoDatabase.obtenerProductoPorIdSubsidiaryGood(bienesList['id_subsidiarygood']);
      ...
      for (int i = 0; i < decodedData['servicios'].length; i++) {
        ...
        var categoryList = await categoryDatabase.obtenerCategoriasporID(decodedData['servicios'][i]['id_category']);
  ...
  Future<int> obtenerProySerPorIdItemsubcategory(String idItemsub) async {
    try {
      final listSubgood = await productoDatabase.obtenerProductoXIdItemSubcategoria(idItemsub);
      ...
      final listSubservice = await subisdiaryServiceDatabase.obtenerServicioXIdItemSubcategoria(idItemsub);
      double mayorSer = 0;
      double mayor2Ser = 0;
      double menorSer = 0;
      ...
      var response = await http.post(Uri.parse("$apiBaseURL/api/Inicio/listar_bs_por_id_itemsubcat"), body: {
        'id_ciudad': '1',
      ...
      if (bienesList.length > 0) {
        for (var i = 0; i < bienesList.length; i++) {
          ...
          await itemsubCategoryDatabase.insertarItemSubCategoria(itemSubCategoriaModel, 'Inicio/listar_bs_por_id_itemsubcat');
          ...
          productoModel.productoCurrency = bienesList[i]['subsidiary_good_currency'];
          productoModel.productoImage = bienesList[i]['subsidiary_good_image'];
          productoModel.productoCharacteristics = bienesList[i]['subsidiary_good_characteristics'];
          ...
          productoModel.productoMeasure = bienesList[i]['subsidiary_good_stock_measure'];
          productoModel.productoRating = bienesList[i]['subsidiary_good_rating'];
          productoModel.productoUpdated = bienesList[i]['subsidiary_good_updated'];
          productoModel.productoStatus = bienesList[i]['subsidiary_good_status'];

          var productList = await productoDatabase.obtenerProductoPorIdSubsidiaryGood(bienesList[i]['id_subsidiarygood']);
          ...
          subsidiaryModel.subsidiaryAddress = bienesList[i]['subsidiary_address'];
          subsidiaryModel.subsidiaryCellphone = bienesList[i]['subsidiary_cellphone'];
          subsidiaryModel.subsidiaryCellphone2 = bienesList[i]['subsidiary_cellphone_2'];
          subsidiaryModel.subsidiaryEmail = bienesList[i]['subsidiary_email'];
          subsidiaryModel.subsidiaryCoordX = bienesList[i]['subsidiary_coord_x'];
          subsidiaryModel.subsidiaryCoordY = bienesList[i]['subsidiary_coord_y'];
          subsidiaryModel.subsidiaryOpeningHours = bienesList[i]['subsidiary_opening_hours'];
          subsidiaryModel.subsidiaryPrincipal = bienesList[i]['subsidiary_principal'];
          subsidiaryModel.subsidiaryStatus = bienesList[i]['subsidiary_status'];
          subsidiaryModel.subsidiaryImg = bienesList[i]['subsidiary_img'];

          final list = await subsidiaryDatabase.obtenerSubsidiaryPorId(bienesList[i]["id_subsidiary"]);
      ...
      if (serviciosList.length > 0) {
        for (var i = 0; i < serviciosList.length; i++) {
          ...
          itemSubCategoriaModel.idSubcategory = serviciosList[i]['id_subcategory'];
          ...
          subsidiaryModel.subsidiaryAddress = serviciosList[i]['subsidiary_address'];
          subsidiaryModel.subsidiaryCellphone = serviciosList[i]['subsidiary_cellphone'];
          subsidiaryModel.subsidiaryCellphone2 = serviciosList[i]['subsidiary_cellphone_2'];
          subsidiaryModel.subsidiaryEmail = serviciosList[i]['subsidiary_email'];
          subsidiaryModel.subsidiaryCoordX = serviciosList[i]['subsidiary_coord_x'];
          subsidiaryModel.subsidiaryCoordY = serviciosList[i]['subsidiary_coord_y'];
          subsidiaryModel.subsidiaryOpeningHours = serviciosList[i]['subsidiary_opening_hours'];
          subsidiaryModel.subsidiaryPrincipal = serviciosList[i]['subsidiary_principal'];
          ...
          subsidiaryServiceModel.idSubsidiaryservice = serviciosList[i]['id_subsidiaryservice'];
          subsidiaryServiceModel.idSubsidiary = serviciosList[i]['id_subsidiary'];
          subsidiaryServiceModel.idService = serviciosList[i]['id_service'];
          subsidiaryServiceModel.idItemsubcategory = serviciosList[i]['id_itemsubcategory'];
          subsidiaryServiceModel.subsidiaryServiceName = serviciosList[i]['subsidiary_service_name'];
          subsidiaryServiceModel.subsidiaryServiceDescription = serviciosList[i]['subsidiary_service_description'];
          subsidiaryServiceModel.subsidiaryServicePrice = serviciosList[i]['subsidiary_service_price'];
          subsidiaryServiceModel.subsidiaryServiceCurrency = serviciosList[i]['subsidiary_service_currency'];
          subsidiaryServiceModel.subsidiaryServiceImage = serviciosList[i]['subsidiary_service_image'];
          subsidiaryServiceModel.subsidiaryServiceRating = serviciosList[i]['subsidiary_service_rating'].toString();
          subsidiaryServiceModel.subsidiaryServiceUpdated = serviciosList[i]['subsidiary_service_updated'];
          subsidiaryServiceModel.subsidiaryServiceStatus = serviciosList[i]['subsidiary_service_status'];

          var servis = await subisdiaryServiceDatabase.obtenerServiciosPorIdSucursalService(serviciosList[i]['id_subsidiaryservice']);

          if (servis.length > 0) {
            subsidiaryServiceModel.subsidiaryServiceFavourite = servis[0].subsidiaryServiceFavourite;
          } else {
            subsidiaryServiceModel.subsidiaryServiceFavourite = '0';
          }
          await subisdiaryServiceDatabase.insertarSubsidiaryService(subsidiaryServiceModel);
