...
class PedidoBloc {
  ...
  Future<List<PedidosModel>> obtnerDetallePedidoXIdPedido() async {
    ...
    for (var i = 0; i < listPedidos.length; i++) {
      ...
      final listdetallePedido =await detallePedidoDb.obtenerDetallePedido(listPedidos[i].idPedido);
 ...
 //-------------Recorrer la lista de Sucursales---------------
    ...
    //pedidosModel.listSubsidiary = listSucursalModel;
      ...
      for (var k = 0; k < listCompanysucursal.length; k++) {
        ...
        //Sucursal
        compSucursalModel.subsidiaryName = listCompanysucursal[k].subsidiaryName;
        compSucursalModel.subsidiaryAddress = listCompanysucursal[k].subsidiaryAddress;
        compSucursalModel.subsidiaryCellphone =listCompanysucursal[k].subsidiaryCellphone;
        compSucursalModel.subsidiaryCellphone2 =listCompanysucursal[k].subsidiaryCellphone2;
        compSucursalModel.subsidiaryEmail = listCompanysucursal[k].subsidiaryEmail;
        compSucursalModel.subsidiaryCoordX = listCompanysucursal[k].subsidiaryCoordX;
        compSucursalModel.subsidiaryCoordY = listCompanysucursal[k].subsidiaryCoordY;
        compSucursalModel.subsidiaryOpeningHours =listCompanysucursal[k].subsidiaryOpeningHours;
        compSucursalModel.subsidiaryPrincipal =listCompanysucursal[k].subsidiaryPrincipal;
        compSucursalModel.subsidiaryStatus = listCompanysucursal[k].subsidiaryStatus;
        ...
        compSucursalModel.companyShortcode = listCompanysucursal[k].companyShortcode;
        compSucursalModel.companyDeliveryPropio = listCompanysucursal[k].companyDeliveryPropio;
        compSucursalModel.companyDelivery = listCompanysucursal[k].companyDelivery;
        compSucursalModel.companyEntrega =listCompanysucursal[k].companyEntrega;
        compSucursalModel.companyTarjeta =listCompanysucursal[k].companyTarjeta;
        compSucursalModel.companyVerified = listCompanysucursal[k].companyVerified;
         compSucursalModel.companyRating = listCompanysucursal[k].companyRating;
        compSucursalModel.companyCreatedAt = listCompanysucursal[k].companyCreatedAt;
