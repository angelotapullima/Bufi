...
class ItemCategoriaBloc {
  ...
  Stream<List<BienesServiciosModel>> get itemSubStream =>
  ...
  Future<List<BienesServiciosModel>> bienesServiciosPorIdItemSubcategoria(
    ...
    final listSubgood =
        await productoDatabase.obtenerProductoXIdItemSubcategoria(id);
  ...
  void listarBienesServiciosXIdItemSubcategoriaFiltrado(
    ...
    if (productos) {
      if (marcas.length > 0) {
        ...
        String sqlMarcas =
            'SELECT * FROM Producto where  producto_brand = $consultaMarcas and id_itemsubcategory="$idItemsubcategory"';
      ...
      if (tallas.length > 0) {
        ...
        String sqlTallas =
            'SELECT * FROM Producto where producto_size  = $consultaTallas and id_itemsubcategory="$idItemsubcategory"';
      ...
      if (modelos.length > 0) {
        ...
        String sqlModelos =
            'SELECT * FROM Producto where producto_model = $consultaModelos and id_itemsubcategory="$idItemsubcategory"';

        final productitosModelo =
            await productoDatabase.sqlConsulta(sqlModelos);
      ...
      if (pasoProdcutos) {
        ...
        for (var i = 0; i < listGeneral.length; i++) {
          ...
          bienesServiciosModel.subsidiaryGoodStock = producto[0].productoStock;
          bienesServiciosModel.subsidiaryGoodMeasure =
              producto[0].productoMeasure;
          bienesServiciosModel.subsidiaryGoodRating =
              producto[0].productoRating;
          bienesServiciosModel.subsidiaryGoodUpdated =
              producto[0].productoUpdated;
          bienesServiciosModel.subsidiaryGoodStatus =
              producto[0].productoStatus;
          bienesServiciosModel.subsidiaryGoodFavourite =
              producto[0].productoFavourite;
          bienesServiciosModel.tipo = 'bienes';

          listFinal.add(bienesServiciosModel);
        }
      } else {
        final listSubgood = await productoDatabase
            .obtenerProductoXIdItemSubcategoria(idItemsubcategory);
        ...
        for (var i = 0; i < listSubgood.length; i++) {
          ...
          bienesServiciosModel.idGood = listSubgood[i].idGood;
          bienesServiciosModel.idItemsubcategory =
              listSubgood[i].idItemsubcategory;
          bienesServiciosModel.subsidiaryGoodName = listSubgood[i].productoName;
          bienesServiciosModel.subsidiaryGoodPrice =
              listSubgood[i].productoPrice;
          bienesServiciosModel.subsidiaryGoodCurrency =
              listSubgood[i].productoCurrency;
          bienesServiciosModel.subsidiaryGoodImage =
              listSubgood[i].productoImage;
          bienesServiciosModel.subsidiaryGoodCharacteristics =
              listSubgood[i].productoCharacteristics;
          bienesServiciosModel.subsidiaryGoodBrand =
              listSubgood[i].productoBrand;
          bienesServiciosModel.subsidiaryGoodModel =
              listSubgood[i].productoModel;
          bienesServiciosModel.subsidiaryGoodType = listSubgood[i].productoType;
          bienesServiciosModel.subsidiaryGoodSize = listSubgood[i].productoSize;
          bienesServiciosModel.subsidiaryGoodStock =
              listSubgood[i].productoStock;
          bienesServiciosModel.subsidiaryGoodMeasure =
              listSubgood[i].productoMeasure;
          bienesServiciosModel.subsidiaryGoodRating =
              listSubgood[i].productoRating;
          bienesServiciosModel.subsidiaryGoodUpdated =
              listSubgood[i].productoUpdated;
          bienesServiciosModel.subsidiaryGoodStatus =
              listSubgood[i].productoStatus;
          bienesServiciosModel.tipo = 'bienes';
    ...
    if (services) {
      final listSubservice = await subServiceDb
          .obtenerServicioXIdItemSubcategoria(idItemsubcategory);
