...
class SubCategoriaGeneralBloc {
  ...
  final _itemSubcategoryController =
  ...
  Stream<List<ItemSubCategoriaModel>> get itemSubcategoryStream =>
      _itemSubcategoryController.stream;
  ...
  Future<List<ItemSubCategoriaModel>> listItems(String id) async {
    ...
    for (var x = 0; x < listItemSubcategoria.length; x++) {
      ...
      itemModel.itemsubcategoryImage =
          listItemSubcategoria[x].itemsubcategoryImage;
