  ...
  insertarAgentes(AgenteModel agenteModel) async {
    try {
      ...
      final res = await db.rawInsert("INSERT OR REPLACE INTO Agentes (id_agente,id_user,id_cuenta,id_city,agente_tipo,agente_nombre,agente_codigo,"
          ...
          "'${agenteModel.agenteTipo}','${agenteModel.agenteNombre}','${agenteModel.agenteCodigo}','${agenteModel.agenteDireccion}',"
          "'${agenteModel.agenteTelefono}','${agenteModel.agenteImagen}','${agenteModel.agenteCoordX}','${agenteModel.agenteCoordY}',"
          "'${agenteModel.agenteEstado}','${agenteModel.idCuentaEmpresa}','${agenteModel.idCompany}','${agenteModel.cuentaeCodigo}',"
          "'${agenteModel.cuentaeSaldo}','${agenteModel.cuentaeMoneda}','${agenteModel.cuentaeDate}','${agenteModel.posicion}','${agenteModel.cuentaeEstado}')");
