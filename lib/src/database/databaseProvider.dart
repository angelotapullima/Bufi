...
class DatabaseProvider {
  ...
  initDB() async {
    ...
    final path = join(documentsDirectory.path, 'bufi11.db');
    ...
    return await openDatabase(path, version: 1, onOpen: (db) {},
      ...
      await db.execute(' CREATE TABLE MisMovimientos('
        ...
        //   ' subsidiary_cellphone_2 TEXT,'
        //   ' subsidiary_email TEXT,'
        //   ' subsidiary_coord_x TEXT,'
        //   ' subsidiary_coord_y TEXT,'
        //   ' subsidiary_opening_hours TEXT,'
        //   ' subsidiary_principal TEXT,'
        //   ' subsidiary_status TEXT,'
        //   ' id_category TEXT,'
        //   ' company_name TEXT,'
        //   ' company_ruc TEXT,'
        //   ' company_image TEXT,'
        //   ' company_type TEXT,'
        //   ' company_shortcode TEXT,'
        //   ' company_delivery_propio TEXT,'
        //   ' company_delivery TEXT,'
        //   ' company_entrega TEXT,'
        //   ' company_tarjeta TEXT,'
        ...
        //   ' company_mt TEXT,'
        //   ' id_good TEXT,'
        //   ' id_itemsubcategory TEXT,'
        //   ' subsidiary_good_name TEXT,'
        //   ' subsidiary_good_price TEXT,'
        //   ' subsidiary_good_currency TEXT,'
        //   ' subsidiary_good_image TEXT,'
        //   ' subsidiary_good_characteristics TEXT,'
        //   ' subsidiary_good_brand TEXT,'
        //   ' subsidiary_good_model TEXT,'
        //   ' subsidiary_good_type TEXT,'
        //   ' subsidiary_good_size TEXT,'
        //   ' subsidiary_good_stock TEXT,'
        //   ' subsidiary_good_stock_measure TEXT,'
        //   ' subsidiary_good_stock_status TEXT,'
        //   ' subsidiary_good_rating TEXT,'
        //   ' subsidiary_good_updated TEXT,'
        //   ' subsidiary_good_status TEXT,'
        //   ' good_name TEXT,'
        //   ' good_synonyms TEXT'
