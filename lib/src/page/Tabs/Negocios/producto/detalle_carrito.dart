                        ...
                        AnimatedPositioned(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: ListarProductosPorSucursalCarrito(
                                  idSucursal: widget.producto.idSubsidiary),
                            ),
                          ),
                        ),
                        AnimatedPositioned(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('${listcarrito[index].carrito[indd].nombre}' +
                                      ' ' +
                                      '${listcarrito[index].carrito[indd].marca}',style: TextStyle(color: Colors.white),),
                                  Text(
                                      '${listcarrito[index].carrito[indd].precio}',
                                  ...
                                  Text(
                                      '${listcarrito[index].carrito[indd].nombre}',style: TextStyle(color: Colors.white)),
                                  CantidadCarrito(
